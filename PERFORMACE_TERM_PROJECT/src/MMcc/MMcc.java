...
//		GammaDistribution M2 = new GammaDistribution(1, 1.0 / 10.0); // Service Rate
		...
		// FINAL
		System.out.println("Execute Time: " + (timeEnd - timeStart) + " milliseconds");
		System.out.println("Blocking Rate = " + nBlocking / nArrival);
		System.out.println("Elaspsed seconds(s) = " + maxTs);
